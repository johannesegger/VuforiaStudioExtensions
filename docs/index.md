...
This site contains a collection of (more or less) useful snippets that can be used in Vuforia Studio projects.
Most examples use "fn.js" - a JavaScript file that can be included in any project with the following steps:

1. Download "fn.js" (e.g. from [here](https://raw.githubusercontent.com/johannesegger/VuforiaStudioExtensions/master/fn.js))
1. Add "fn.js" as resource to your Vuforia Studio project

    ![fn.js added as resource](fn-js-as-resource.png)
...
>
>   ![Application event handlers](application-event-handler-text-box.png)
...
>
>   ![Model property event handlers](model-property-event-handler-text-box.png)
